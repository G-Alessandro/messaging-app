...
exports.sign_up_post = [
  ...
  body('password', 'Password name must not be empty.').trim().isLength({ min: 1, max: 30 }).escape(),
  body('confirmPassword', 'Confirm password must match password.').trim().isLength({ min: 1, max: 30 }).escape()
    .custom((value, { req }) => {
